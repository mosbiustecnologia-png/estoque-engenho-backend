  ...
  const handleSubmit = async () => {
    ...
    if (parseInt(quantidade) > produto.estoque_atual) {
      Alert.alert(
        ...
        `Você está tentando retirar ${quantidade} unidade(s), mas há apenas ${produto.estoque_atual} em estoque.`
      );
      return;
    }
    ...
    try {
      ...
      await movimentacoesAPI.saida(dados);

      const novoEstoque = produto.estoque_atual - parseInt(quantidade);

      Alert.alert(
        'Saída Registrada!',
        `${quantidade} unidade(s) retirada(s) de ${produto.nome}\nNovo estoque: ${novoEstoque}`,
        [
          { text: 'Nova Saída', onPress: () => limparFormulario() },
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.header}>
          <View style={styles.headerIcon}>
            <Ionicons name="arrow-up-circle" size={40} color="#F44336" />
          </View>
          <Text style={styles.headerTitle}>Saída de Estoque</Text>
          <Text style={styles.headerSubtitle}>
            Registre vendas e retiradas
          </Text>
        </View>
        ...
        {produto && (
          <View style={styles.produtoCard}>
            <View style={styles.produtoHeader}>
              <Ionicons name="cube" size={32} color="#F44336" />
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            placeholder="Ex: Venda loja, Venda Mercado Livre"
            multiline
            numberOfLines={3}
            editable={!loading}
          />
